...
![Telerik UI for .NET MAUI QR Code visual structure showing the square module grid](images/barcode-2d-barcodes-qrcode-overview001.png)

![Telerik UI for .NET MAUI QR Code visual structure showing version growth from 21 by 21 to 177 by 177 modules](images/barcode-2d-barcodes-qrcode-overview002.png)
...
![Telerik UI for .NET MAUI QR Code module groups showing finder, alignment, timing, format, version, and data areas](images/barcode-2d-barcodes-qrcode-overview003.png)
...
* Blank Space&mdash;Additionally, around each QR code, has an obligatory 4-modules-wide space area:
  ...
  ![Telerik UI for .NET MAUI QR Code showing the required four-module blank space around the symbol](images/barcode-2d-barcodes-qrcode-overview004.png)
...
![Telerik UI for .NET MAUI Barcode displaying a generated QR Code](images/barcode-2d-barcodes-qrcode-example.png)
