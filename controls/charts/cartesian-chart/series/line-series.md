...
1. Define the `LineSeries` and the chart definition in XAML:
...
![Telerik UI for .NET MAUI CartesianChart LineSeries with a red line across monthly categories](../images/charts-cartesian-line-series.png)
