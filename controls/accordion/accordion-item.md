...
This article explains the configuration options of the Accordion Item.
...
![Telerik UI for .NET MAUI AccordionItem with an expanded Settings section and checkbox content](images/accordion-accordionitem.png)
