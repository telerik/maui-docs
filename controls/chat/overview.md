...
![Telerik UI for .NET MAUI Chat showing an assistant message with an attached image file and message input area](images/chat-overview.png)
...
* [MVVM support]({%slug chat-mvvm-support %})&mdash;With the `RadChat` control, you can use the Model-View-ViewModel pattern. You can achieve this by binding the `ItemsSource` property to a collection of any data items that will be converted into chat items.
