...
![Telerik UI for .NET MAUI CollectionView item style showing teal border color and selected item background color with visual states for selected and mouse over](../images/collectionview-item-style.png "Telerik .NET MAUI CollectionView")
