...
![Telerik UI for .NET MAUI CollectionView item style showing teal borders and alternating item backgrounds](../images/collectionview-item-style.png "Telerik .NET MAUI CollectionView")
