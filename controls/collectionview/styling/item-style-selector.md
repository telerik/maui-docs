...
![Telerik UI for .NET MAUI CollectionView item style selector applying alternating teal background color to city items](../images/collectionview-item-style-selector.png "Telerik .NET MAUI CollectionView")
