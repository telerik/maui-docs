...
![Telerik UI for .NET MAUI CollectionView group style with teal color for the country headers with expand and collapse indicators](../images/collectionview-group-view-style.png "Telerik .NET MAUI CollectionView")
