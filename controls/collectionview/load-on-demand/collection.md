...
![Telerik UI for .NET MAUI CollectionView loading additional Person items on demand from the built-in load on demand collection](../images/load-on-demand.gif "Telerik .NET MAUI CollectionView")
