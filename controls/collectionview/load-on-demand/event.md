...
![Telerik UI for .NET MAUI CollectionView manually loading additional Person items through the LoadOnDemand event](../images/load-on-demand-manual-mode.gif "Telerik .NET MAUI CollectionView")
