...
![Telerik UI for .NET MAUI CollectionView loading additional Person items on demand using the load on demand command](../images/load-on-demand.gif "Telerik .NET MAUI CollectionView")
