...
![Telerik UI for .NET MAUI CollectionView empty template showing a folder illustration](images/collectionview-empty-template.png "Telerik .NET MAUI CollectionView")
