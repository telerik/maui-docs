...
![Telerik UI for .NET MAUI CollectionView sorted in descending order with Sort Descending and Clear Sorting buttons](images/collectionview-sorting.gif "Telerik .NET MAUI CollectionView")
