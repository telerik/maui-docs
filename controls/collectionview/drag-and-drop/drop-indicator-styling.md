...
![Telerik UI for .NET MAUI CollectionView with a customized teal color for the drop indicator line and circular handle](../images/collectionview-dragdrop-dropindicatorstyle.png)
