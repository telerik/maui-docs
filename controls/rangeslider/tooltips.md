...
RangeSlider for .NET MAUI can display a tooltip to indicate the currently selected range to the end-user. The tooltip is shown as soon as the user starts dragging the start thumb, the range track or the end thumb.
