...
[Telerik UI for .NET MAUI DataGrid]({%slug datagrid-overview%}) provides a built-in grouping functionality, which allows the user to easy group the data by one or more columns.
