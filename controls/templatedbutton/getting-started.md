...
# Getting Started with the .NET MAUI TemplatedButton

This guide provides the information you need to start using the Telerik UI for .NET MAUI TemplatedButton by adding the control to your project.

At the end, you will achieve the following result.

![.NET MAUI TemplatedButton Getting Started](images/button-getting-started.png)

## Prerequisites

Before adding the TemplatedButton, you need to:
