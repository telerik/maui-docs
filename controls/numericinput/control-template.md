...
The visual appearance of the NumericInput is defined through a Control Template. To customize the way the NumericInput looks, you will need to take the default `ControlTemplate` and modify it.
