...
![Telerik UI for .NET MAUI Calendar century view with a decade style selector applying purple styles to decade ranges](images/calendar-decadestyle-selector.png)
