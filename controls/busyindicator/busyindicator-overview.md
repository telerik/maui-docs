...
- [Custom animations]({%slug busyindicator-animations%}#custom-animations)&mdash;The control allows you to define custom content and animate it by using the `RadAnimation` class.
