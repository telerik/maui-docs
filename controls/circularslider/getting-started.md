...
![Telerik UI for .NET MAUI CircularSlider rendered with platform-specific arc and thumb styles on Windows and Android](images/circularslider-getting-started.png)
