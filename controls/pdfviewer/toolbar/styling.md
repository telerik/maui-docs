...
All properties applicable for [`NavigationButtonToolbarItemView`]({%slug toolbar-items-navigation-button%}) can be used for styling the `PdfViewerSearchNavigationToolbarItem`.
