...
![Telerik UI for .NET MAUI AutoComplete with customized suggestion item color, suggestionview border, autocomplete background and border and highlighted search results with the visual states](images/autocomplete-styling.png)
