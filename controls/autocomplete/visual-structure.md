...
![Telerik UI for .NET MAUI AutoComplete visual structure labeling the Placeholder in the input field](images/autocomplete-placeholder.png "Visual elements of AutoComplete control")

- `Placeholder`&mdash;The text that guides the end-user on what can be entered/searched in the input.

## Tokens Structure

![Telerik UI for .NET MAUI AutoComplete Tokens visual structure labeling a token and ShowMore Template](images/autocomplete-tokens-template.png "Visual elements of AutoComplete control")
...
![Telerik UI for .NET MAUI AutoComplete filtering visual structure labeling the text, RadTextInput, clear button, and filtered items](images/autocomplete-focused-text.png "Visual elements of AutoComplete control")
