...
- `RadiusFactor`&mdash;Defines the radius factor used to calculate the radius of the visual series. This value is usually within the [0,1] range but its possible to oversize the series by setting a value greater than 1.
