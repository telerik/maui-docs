...
![Telerik UI for .NET MAUI BottomSheet being resized by dragging its handle with a swipe gesture](images/bottomsheet-swipe-gesture.gif "BottomSheet Swipe Gesture")
