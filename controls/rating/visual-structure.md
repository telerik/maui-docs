...
![Rating Visual Structure](images/rating-visual-structure.png)
...
- [Getting Started with .NET MAUI Rating]({%slug rating-getting-started%})
- [Shapes]({%slug rating-shape-rating%})
