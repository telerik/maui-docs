...
3. Register the AI service and AI chat client in your application.
    ...
    For the example, we will use the `Azure.AI.OpenAI` and `Microsoft.Extensions.AI.OpenAI` packages. Add these packages to your project. To register the AI service and chat client, the following code is needed in `MauiProgram.cs`:
