...
* `CursorPosition` (`int`)&mdash;Specifies the starting position of the cursor. The value must be more than or equal to `0` and less or equal to the length of text.
