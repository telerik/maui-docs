...
description: "Get started with Telerik UI for .NET MAUI. Set up your license, create a .NET MAUI project, install the Telerik package, register the controls, and add your first component."
