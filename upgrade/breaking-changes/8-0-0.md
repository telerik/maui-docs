...
* The  `Geometries` class in namespace `Telerik.Maui.Controls.Compatibility.Input` is deleted. All properties and methods are moved to the `RadGeometry` class in the `Telerik.Maui.Controls` namespace.
...
* The `RatingConstants` class is moved from the `Telerik.Maui.Controls.Compatibility.Input` namespace to the `Telerik.Maui.Controls` namespace.
* The `RatingItem` class is moved from the `Telerik.Maui.Controls.Compatibility.Input` namespace to the `Telerik.Maui.Controls` namespace.
* The `RatingItemBase` class is moved from the `Telerik.Maui.Controls.Compatibility.Input` namespace to the `Telerik.Maui.Controls` namespace.
* The `RatingItemTappedCommand` class is moved from the `Telerik.Maui.Controls.Compatibility.Input` namespace to the `Telerik.Maui.Controls` namespace.
