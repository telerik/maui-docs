...
> With **Telerik .NET MAUI 7.1.0** version we have added a support for .NET 9.0 Preview 6. You can easily switch the .NET version to .NET 8.0 or .NET 9.0 to build the apps. 
