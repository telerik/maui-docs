...
title: Overview
page_title: Overview
description: Learn how to secure Telerik UI for .NET MAUI components and your .NET MAUI app with best practices, vulnerability reporting, and component-specific security guidelines.
slug: security-overview
tags: telerik, .net maui, security, xss, owasp, csp
published: True
position: 1
---
